...
uint256 hashGenesisBlock("0x41e5c2b97e981b1045594fed0aef9fbd7eaba56f814f6ac6ebe2354f2eec572c");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Hyperon: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Hyperon Signed Message:\n";
...
{
    // Hyperon: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Hyperon: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Hyperon: 3.5 days
static const int64 nTargetSpacing = 150; // Hyperon: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Hyperon: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Hyperon: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Hyperon: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x9f4f984c317dcf1b8071118008c34023bbcea86553bc38963d2bf8264b57ecb9");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Hyperon";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("d14c8df5a210c0b781400b76b821bceb32b294c1ebc370881bb40d52b0bc0c08fd9dd60990c79a35275d07abcc26346f69ad279701556eb77d15f3bd15a18e2bbe") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1512798321;
        block.nBits    = 504365644;
        block.nNonce   = 893410588;

        if (fTestNet)
        {
            block.nTime    = 1512798321;
            block.nNonce   = 2174219801;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xb9f86ea909d1dc7019d5f72be24160819742458174978bc7c5c422c461e8e974"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Hyperon: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("HyperonMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("HyperonMiner : ProcessBlock, block not accepted");
    }
